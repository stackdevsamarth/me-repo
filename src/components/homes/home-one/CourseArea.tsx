...
const tab_title: string[] = ["All Workshop", "Business", "Development", "Design", "Finance"];
          ...
          <div className="row justify-content-center">
            <div className="col-lg-6">
              <div className="section__title text-center mb-40">
                <span className="sub-title">Featured Opportunities</span>
                <h2 className="title">Join Our Upcoming Workshops</h2>
                <p className="desc">Unlock new skills and insights in hands-on sessions designed to inspire and empower your journey. Stay ahead, stay curious!</p>
              </div>
