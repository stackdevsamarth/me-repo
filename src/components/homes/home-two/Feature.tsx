            ...
            <div className="row justify-content-center">
               <div className="col-xl-6 col-lg-8">
                  <div className="section__title text-center mb-40">
                     ...
                     <h2 className="title">Empowering Learners for the Future</h2>
                     <p>Our Workshops & Bootcamps are designed to equip the real world skills that matter. <br /> We prepare you to thrive in a competitive, Ai-driven world.</p>
                  </div>
               </div>
            </div>
