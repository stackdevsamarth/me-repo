                  ...
                  <div className="fact__inner-wrap-two">
                     <div className="section__title white-title mb-30">
                        <h2 className="title">Numbers of
                           ...
                           authored by domain experts</h2>
                     </div>
                     <div className="fact__item-wrap">
                        <div className="fact__item">
                           <h2 className="count"><Count number={100} />+</h2>
                           <p>Active Students</p>
                        </div>
                        <div className="fact__item">
                           <h2 className="count"><Count number={5} />+</h2>
