            ...
            <div className="row align-items-center justify-content-center">
               ...
               <div className="col-lg-6">
                  <div className="about__content">
                     ...
                     <p className="desc">MetaEd School is a next-generation ed-tech platform dedicated to preparing learners with hands-on, practical skills that align with modern industry demands.</p>
                     <ul className="about__info-list list-wrap">
                        <li className="about__info-list-item">
                           <i className="flaticon-angle-right"></i>
                           <p className="content">Advanced Technology Integration</p>
                        </li>
                        <li className="about__info-list-item">
                           <i className="flaticon-angle-right"></i>
                           <p className="content">Community and Collaboration Focus</p>
                        </li>
                        <li className="about__info-list-item">
                           <i className="flaticon-angle-right"></i>
                           <p className="content">Global Perspective with Local Relevance</p>
                        </li>
                     </ul>
                     <div className="tg-button-wrap">
                        <Link href="/about-us" className="btn arrow-btn">Contact us <BtnArrow /></Link>
                     </div>
                  </div>
               </div>
            </div>
