               ...
               <div className="row align-items-center justify-content-center">
                  ...
                  <div className="col-lg-6">
                     <div className="about__content-three">
                        ...
                        <p className="desc">MetaEd School is a next-generation ed-tech platform dedicated to preparing learners with hands-on, practical skills that align with modern industry demands. Our mission is to bridge the gap between theory and practice, empowering students to excel with real-world knowledge.</p>
                        <ul className="about__info-list list-wrap">
                           <li className="about__info-list-item">
                              <i className="flaticon-angle-right"></i>
                              <p className="content">Student first approach</p>
                           </li>
                           <li className="about__info-list-item">
                              <i className="flaticon-angle-right"></i>
                              <p className="content">Commitment to real world skills</p>
                           </li>
                           <li className="about__info-list-item">
                              <i className="flaticon-angle-right"></i>
                              <p className="content">Continous learning & growth</p>
                           </li>
                        </ul>
